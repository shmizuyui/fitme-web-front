    ...
    <>
      ...
      <div className="w-2/3 mx-auto mt-10">
        ...
        <ul className="flex flex-wrap justify-center text-center text-xl">
          <Category image="/muscle.jpg" category="muscle">
            筋トレ
          </Category>
          <Category image="/aerobic_exercise.jpg" category="aerobic_exercise">
            有酸素運動
          </Category>
          <Category image="/yoga.jpg" category="yoga">
            ヨガ
          </Category>
          <Category image="/pilates.jpg" category="pilates">
            ピラティス
          </Category>
          <Category image="/stretch.jpg" category="stretch">
            ストレッチ
          </Category>
          <Category image="/meal.jpg" category="meal_management">
            食事管理
          </Category>
          <Category image="/counseling.jpg" category="counseling">
            カウンセリング
          </Category>
        </ul>
      </div>
